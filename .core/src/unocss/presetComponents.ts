...
const defaultOptions: any = {
  ...
  `,
  button:
    'gap-xs text-hue11 hover:text-hue12 inline-flex cursor-pointer items-center justify-center whitespace-nowrap rounded-size2 p-size3 text-center text-size2 font-base leading-[1] transition active:scale-95 disabled:pointer-events-none disabled:opacity-25 disabled:cursor-not-allowed',
  'button-group':
    'flex w-full gap-x-size3 gap-y-size2 flex-wrap size-small:max-w-xl size-large:max-w-3xl max-w-2xl',
  link: 'whitespace-nowrap text-size2 text-hue11 hover:text-hue12 disabled:pointer-events-none disabled:opacity-25 font-base',
  form: 'flex flex-col gap-size3 size-small:max-w-md size-large:max-w-xl max-w-lg',
  input:
    'variant-surface p-.4rem text-primary text-hue12 bg-hue4 border border-hue6 rounded-size1 placeholder:text-hue11 disabled:pointer-events-none disabled:opacity-25',
  select:
    'variant-surface p-.4rem text-primary text-hue12 shrink-0 rounded-size1 text-hue12 py-0.9375em disabled:pointer-events-none disabled:opacity-25',
  textarea:
    'rounded-size1 variant-surface p-.4rem bg-hue4 border border-hue6 min-h-5rem text-hue12 placeholder:text-hue11 disabled:pointer-events-none disabled:opacity-25',
